...
class StringSelect(BaseComponent):
    def __init__(
        ...
        *,
        ...
        self.type = ComponentType.string_select.value
        self.custom_id = custom_id
...
class MentionableSelect(BaseComponent):
    def __init__(
        ...
        *,
        ...
        self.type = ComponentType.mentionable_select.value
        self.custom_id = custom_id
        self.placeholder = placeholder
        self.disabled = disabled
...
class DatePicker(BaseComponent):
    def __init__(
        ...
        *,
        ...
        self.type = ComponentType.date_picker.value
        self.custom_id = custom_id
        self.style = style
        self.placeholder = placeholder
        self.disabled = disabled
...
class TextDisplay(BaseComponent):
    def __init__(self, *, content: str):
        self.type = ComponentType.text_display.value
...
class Separator(BaseComponent):
    def __init__(
        ...
        *,
        ...
        self.type = ComponentType.separator.value
...
class Container(BaseComponent):
    def __init__(
        ...
        *,
        ...
        self.type = ComponentType.container.value
        self.components = components
...
class Section(BaseComponent):
    def __init__(self, *, text: str, accessory: Optional[BaseComponent] = None):
        self.type = 9
        self.text = text
